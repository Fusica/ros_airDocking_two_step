...
def nominal_position_cb(data):
    ...
    nominal_pos = np.array([data.pose.position.y, -data.pose.position.x-1.3, data.pose.position.z])
...
nominal_position_sub = rospy.Subscriber("/child1/mavros/local_position/pose", PoseStamped, nominal_position_cb, queue_size=1)
