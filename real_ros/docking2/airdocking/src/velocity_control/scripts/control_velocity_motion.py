...
def timecallback(event):
    ...
    if 1: #start == 1:
        ...
        err_pos[0] = pos[0] - nominal_pos[0] #- 0.15
        err_pos[1] = pos[1] - nominal_pos[1] #+ 0.2
        err_pos[2] = pos[2] - nominal_pos[2] #- 0.05
...
px4_command_pub_ = rospy.Publisher("/des_attitude", AttitudeTarget, queue_size=1)
...
state_pos_sub = rospy.Subscriber("/state_pos", Point, state_pos_cb, queue_size=1)
nominal_position_sub = rospy.Subscriber("/nominal_position", Point, nominal_position_cb, queue_size=1)
