...
#6. python /home/jetson/airdocking/src/transmitacr/script/transmitter2.py
...
# 1. roslaunch vrpn_client_ros sample.launch server:=192.168.1.101
#2. roslaunch mavros px4.launch fcu_url:=serial:///dev/ttyACM0:57600

#3. rosrun topic_tools relay /vrpn_client_node/UAV2/pose /mavros/vision_pose/pose
