    ...
    while not rospy.is_shutdown():
        ...
        if quadrotor2_mode == 'OFFBOARD':
            if quadrotor1_mode != 'OFFBOARD':
                ...
                child2_hover_flag = child2_hover_check.check(tolerance_variance_pos=1.2) # 悬停检测 0.7
                ...
                # 计算当前桶间位置
                child2_jian_position_world_frame = np.array([child2_pose.pose.position.x, child2_pose.pose.position.y, child2_pose.pose.position.z]) - np.array([0.41, 0, 0])
                ...
                if far_away_flag:
                    ...
                    two_x = max(two_x, child1_pose.pose.position.x + 0.73)
                ...
                child2_hover_flag = child2_hover_check2.check(tolerance_variance_pos=1.2)
